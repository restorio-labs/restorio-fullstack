...
export const generateCSSVariables = (
  ...
  if (override.spacing) {
    Object.assign(
      variables,
      flattenToCSSVariables(override.spacing, "spacing"),
    );
  }
  ...
  if (override.typography) {
    if (override.typography.fontFamily) {
      Object.assign(
        variables,
        flattenToCSSVariables(override.typography.fontFamily, "font-family"),
      );
    }
    ...
    if (override.typography.fontSize) {
      Object.assign(
        variables,
        flattenToCSSVariables(override.typography.fontSize, "font-size"),
      );
    }
    ...
    if (override.typography.fontWeight) {
      Object.assign(
        variables,
        flattenToCSSVariables(override.typography.fontWeight, "font-weight"),
      );
    }
  }

    ...
    <Stack spacing="lg" className="max-w-5xl">
      ...
      <Stack spacing="md">
        ...
        <Stack direction="row" spacing="lg" wrap>
          <Stack direction="row" spacing="sm" className="p-4 border border-border-default rounded-lg bg-surface-primary">
            {items.map((item) => (
          ...
          <Stack direction="column" spacing="sm" className="p-4 border border-border-default rounded-lg bg-surface-primary">
            {items.map((item) => (
              <Box key={item} className="px-3 py-2 rounded-md bg-surface-secondary">
                {item}
              </Box>

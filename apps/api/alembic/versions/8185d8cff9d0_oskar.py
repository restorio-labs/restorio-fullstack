...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('TenantStatus', name='tenant_status', create_constraint=True), nullable=False),
    ...
    op.create_index('idx_audit_logs_tenant_id_created_at', 'audit_logs', ['tenant_id', 'created_at'], unique=False)
    ...
    op.create_index('idx_restaurant_tables_tenant_id', 'restaurant_tables', ['tenant_id'], unique=False)
    ...
    sa.Column('status', sa.Enum('OrderStatus', name='order_status', create_constraint=True), nullable=False),
    ...
    op.create_index('idx_orders_tenant_id_created_at', 'orders', ['tenant_id', 'created_at'], unique=False)
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('order_id', sa.UUID(), nullable=False),
    sa.Column('provider', sa.Enum('PRZELEWY24', 'CASH', 'TERMINAL', 'OTHER', name='payment_provider', create_constraint=True), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'COMPLETED', 'FAILED', 'REFUNDED', name='payment_status', create_constraint=True), nullable=False),

globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/router-DJR_EuCw.js","assets/query-BbOc3VB2.js","assets/worker-entry-_hEu9HBd.js"];
...
var MIDDLEWARE_SET_COOKIE_HEADER$1 = "x-middleware-set-cookie";
...
function shouldKeepMiddlewareHeader(key) {
	return key === MIDDLEWARE_OVERRIDE_HEADERS || key === MIDDLEWARE_SET_COOKIE_HEADER$1 || key.startsWith(MIDDLEWARE_REQUEST_HEADER_PREFIX);
}
//#endregion
...
var VINEXT_RSC_MOUNTED_SLOTS_HEADER = "X-Vinext-Mounted-Slots";
var VINEXT_RSC_HEADER = "RSC";
var VINEXT_RSC_INTERCEPTION_CONTEXT_HEADER = "X-Vinext-Interception-Context";
...
var NextRequest = class extends Request {
	...
	constructor(input, init) {
		...
		this._nextUrl = new NextURL(url, void 0, _nextConfig ? {
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "42c8b393-2dbf-41bd-a8c5-20430f787ed3";
	}
};
...
//#endregion
//#region src/i18n/request.ts
var locales = ["pl"];
async function loadMessages(locale) {
	try {
		return (await _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({
			"../locales/ar.json": () => import("./assets/ar-GSuLsgk_.js"),
			"../locales/en.json": () => import("./assets/en-DsKLdwc6.js"),
			"../locales/es.json": () => import("./assets/es-C7kvGPv9.js"),
			"../locales/pl.json": () => import("./assets/pl-DZLJ7Yow.js")
...
function proxy(request) {
	...
	if (locales.some((locale) => pathname.startsWith(`/${locale}/`) || pathname === `/${locale}`)) return NextResponse.next();
	const url = request.nextUrl.clone();
	url.pathname = `/pl${pathname}`;
	return NextResponse.redirect(url);
}
var config = { matcher: ["/((?!api|_next|_vercel|.*\\..*).*)"] };
//#endregion
...
var SERVER_ACTION_NOT_FOUND_HEADER = "x-nextjs-action-not-found";
...
}, "d9c68aa4d77e", "ForbiddenBoundary");
...
}, "d9c68aa4d77e", "UnauthorizedBoundary");
//#endregion
...
}, "f68eb037b69c", "LayoutSegmentProvider");
//#endregion
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "42c8b393-2dbf-41bd-a8c5-20430f787ed3") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "42c8b393-2dbf-41bd-a8c5-20430f787ed3",
		rootBoundaryId
	});
}
/**
...
//#endregion
//#region app/[locale]/(marketing)/about/AboutContent.tsx
var AboutContent = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'AboutContent' is called on server");
}, "cc29ad35135c", "AboutContent");
//#endregion
//#region src/i18n/metadata.ts
var resolveMetadataBaseUrl = () => {
...
var isPageKey = (value) => PAGE_KEYS.includes(value);
var resolveLocale = (locale) => {
	if (locales.includes(locale)) return locale;
	return "en";
};
var getNestedValue$2 = (obj, path) => {
	const keys = path.split(".");
	let current = obj;
	for (const key of keys) if (typeof current === "object" && key in current) current = current[key];
	else return path;
	return typeof current === "string" ? current : path;
};
var getRootMetadata = async (locale) => {
	const safeLocale = resolveLocale(locale);
	const metadata = (await loadMessages(safeLocale)).metadata;
	const siteTitle = getNestedValue$2(metadata, "title");
	const siteDescription = getNestedValue$2(metadata, "description");
	...
	return {
		...
		other: { "restorio-app-version": appVersion },
		openGraph: {
			type: "website",
			siteName: siteTitle,
...
var getPageMetadata = async (locale, pageKey) => {
	const safeLocale = resolveLocale(locale);
	const safePageKey = isPageKey(pageKey) ? pageKey : "home";
	const metadata = (await loadMessages(safeLocale)).metadata;
	const title = getNestedValue$2(metadata, `pages.${safePageKey}.title`);
	const description = getNestedValue$2(metadata, `pages.${safePageKey}.description`);
	return {
		title,
		description,
		openGraph: {
...
//#endregion
//#region app/[locale]/(marketing)/about/page.tsx
var page_exports$9 = /* @__PURE__ */ __exportAll({
	default: () => AboutPage,
	generateMetadata: () => generateMetadata$9
});
async function generateMetadata$9({ params }) {
	const { locale } = await params;
	return getPageMetadata(locale, "about");
}
function AboutPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(AboutContent, {});
}
...
})(import_react_react_server.default, assetsManifest.serverResources["app/[locale]/layout.tsx"], void 0, "vite-rsc/importer-resources");
//#endregion
...
getEnvVar("REFRESH_TOKEN_KEY");
getEnvVar("SESSION_HINT_COOKIE");
var THEME_STORAGE_KEY = getEnvVar("THEME_STORAGE_KEY") ?? "rtm";
getEnvVar("LANGUAGE_LOCALE_STORAGE_KEY");
getEnvVar("LAST_VISITED_APP_STORAGE_KEY");
getEnvVar("CROSS_APP_BACKUP_STORAGE_KEY");
getEnvVar("RESTORIO_SELECTED_TENANT_ID");
var createInitialLayout = (tenantId, name, width, height) => ({
...
({ ...createInitialLayout("venue-1", "Main Hall", 800, 600) }), createInitialLayout("venue-2", "Outdoor", 600, 400);
//#endregion
//#region ../../packages/ui/dist/chunk-TNJQCDL4.js
var getThemeBootScript = () => `
(() => {
  try {
...
`;
//#endregion
//#region src/wrappers/AppProviders.tsx
...
}, "70319900f8bf", "AppProviders");
//#endregion
//#region app/[locale]/layout.tsx
var layout_exports$2 = /* @__PURE__ */ __exportAll({
	default: () => $$wrap_RootLayout,
	generateMetadata: () => generateMetadata$8,
	viewport: () => viewport
});
var viewport = {
	width: "device-width",
...
async function generateMetadata$8({ params }) {
	const { locale } = await params;
...
async function RootLayout({ children, params }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("script", { dangerouslySetInnerHTML: { __html: themeBootScript } }) }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("body", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
			href: "#main-content",
			...
			children: messages.common.skipToContent ?? "Skip to content"
		}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(AppProviders, {
			locale,
			messages,
			children
		})] })]
...
//#endregion
//#region app/[locale]/(marketing)/layout.tsx
var layout_exports$1 = /* @__PURE__ */ __exportAll({ default: () => layout_default$1 });
var layout_default$1 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "c8475511e12c", "default");
//#endregion
//#region app/[locale]/(public)/activate/ActivateContent.tsx
var ActivateContent = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ActivateContent' is called on server");
}, "c086d9f96633", "ActivateContent");
//#endregion
//#region app/[locale]/(public)/activate/page.tsx
var page_exports$8 = /* @__PURE__ */ __exportAll({
	default: () => ActivatePage,
	generateMetadata: () => generateMetadata$7
});
async function generateMetadata$7({ params }) {
	const { locale } = await params;
...
function ActivatePage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ActivateContent, {})
	});
}
//#endregion
//#region app/[locale]/(public)/layout.tsx
var layout_exports = /* @__PURE__ */ __exportAll({ default: () => layout_default });
var layout_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "2e6a9e6adb31", "default");
//#endregion
//#region app/[locale]/(public)/forgot-password/ForgotPasswordContent.tsx
var ForgotPasswordContent = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ForgotPasswordContent' is called on server");
}, "f5f364655427", "ForgotPasswordContent");
//#endregion
//#region app/[locale]/(public)/forgot-password/page.tsx
var page_exports$7 = /* @__PURE__ */ __exportAll({
	default: () => ForgotPasswordPage,
	generateMetadata: () => generateMetadata$6
});
async function generateMetadata$6({ params }) {
	const { locale } = await params;
...
function ForgotPasswordPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
			className: "rounded-2xl border border-border-default bg-surface-primary p-8 sm:p-10 shadow-sm animate-slide-up",
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ForgotPasswordContent, {})
		})
	});
}
//#endregion
//#region app/[locale]/(public)/login/LoginContent.tsx
var LoginContent = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'LoginContent' is called on server");
}, "c70312da47e6", "LoginContent");
//#endregion
//#region app/[locale]/(public)/login/page.tsx
var page_exports$6 = /* @__PURE__ */ __exportAll({
	default: () => LoginPage,
	generateMetadata: () => generateMetadata$5
});
async function generateMetadata$5({ params }) {
	const { locale } = await params;
...
function LoginPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
			className: "rounded-2xl border border-border-default bg-surface-primary p-8 sm:p-10 shadow-sm animate-slide-up",
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(LoginContent, {})
		})
	});
}
//#endregion
//#region src/components/legal/AnimatedReveal.tsx
var AnimatedReveal_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "5a0f10ec9a19", "default");
//#endregion
//#region src/components/legal/LegalPageLayout.tsx
var LegalPageLayout = ({ children }) => {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
		className: "w-full bg-background-primary text-text-primary scroll-smooth",
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("main", {
			id: "legal-main",
...
//#endregion
//#region src/components/legal/LegalSection.tsx
var LegalSection = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'LegalSection' is called on server");
}, "3d58725dfa1b", "LegalSection");
//#endregion
//#region src/components/legal/TableOfContents.tsx
var TableOfContents = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'TableOfContents' is called on server");
}, "71866882840c", "TableOfContents");
//#endregion
//#region app/[locale]/(marketing)/privacy/page.tsx
var page_exports$5 = /* @__PURE__ */ __exportAll({
	default: () => PrivacyPage,
	generateMetadata: () => generateMetadata$4
});
var getNestedValue$1 = (obj, path, values) => {
	const keys = path.split(".");
	let current = obj;
	for (const key of keys) if (typeof current === "object" && key in current) current = current[key];
	else return path;
	let result = typeof current === "string" ? current : path;
	if (values) for (const [k, v] of Object.entries(values)) result = result.replace(new RegExp(`\\{${k}\\}`, "g"), v);
	return result;
};
async function generateMetadata$4({ params }) {
	const { locale } = await params;
	const legal = (await loadMessages(locale)).legal;
	return {
		title: getNestedValue$1(legal, "privacyPolicy.title"),
		description: "Polityka Prywatności oraz Polityka Cookies platformy Restorio do zarządzania restauracją."
	};
}
var PrivacyPage = async ({ params }) => {
	const { locale } = await params;
	const legal = (await loadMessages(locale)).legal;
	const t = (key, values) => getNestedValue$1(legal, key, values);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(LegalPageLayout, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", {
				...
				children: t("privacyPolicy.title")
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(TableOfContents, {
					sections: privacySections,
					namespace: "privacyPolicy"
				}),
				privacySections.map((sectionId) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(LegalSection, {
					id: sectionId,
					namespace: `privacyPolicy.sections.${sectionId}`
				}, `privacyPolicy:${sectionId}`)),
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
					id: "cookies",
					className: "mt-12 scroll-mt-24",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(AnimatedReveal_default, {
							className: "mb-4",
							delayMs: 0,
							children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", {
								className: "text-2xl font-semibold",
								children: t("cookiePolicy.title")
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(AnimatedReveal_default, {
							delayMs: 120,
							children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(TableOfContents, {
								sections: cookieSections,
								namespace: "cookiePolicy"
							})
						}),
						cookieSections.map((sectionId) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(LegalSection, {
							id: sectionId,
							namespace: `cookiePolicy.sections.${sectionId}`
						}, `cookiePolicy:${sectionId}`))
					]
				})
			] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("aside", {
				className: "hidden lg:block",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "sticky top-24 space-y-4 text-sm text-text-secondary",
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("strong", { children: [t("common.lastUpdated"), ":"] }),
						" ",
						lastUpdatedDate
					] })
				})
...
//#endregion
//#region app/[locale]/(public)/register/RegisterContent.tsx
var RegisterContent = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'RegisterContent' is called on server");
}, "317ad3371a80", "RegisterContent");
//#endregion
//#region app/[locale]/(public)/register/page.tsx
var page_exports$4 = /* @__PURE__ */ __exportAll({
	default: () => RegisterPage,
	generateMetadata: () => generateMetadata$3
});
async function generateMetadata$3({ params }) {
	const { locale } = await params;
...
function RegisterPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
			className: "rounded-2xl border border-border-default bg-surface-primary p-8 sm:p-10 shadow-sm animate-slide-up",
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(RegisterContent, {})
		})
	});
}
//#endregion
//#region app/[locale]/(public)/reset-password/ResetPasswordContent.tsx
var ResetPasswordContent = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'ResetPasswordContent' is called on server");
}, "8596262c55eb", "ResetPasswordContent");
//#endregion
//#region app/[locale]/(public)/reset-password/page.tsx
...
function ResetPasswordPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
		className: "mx-auto max-w-2xl px-4 py-16",
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ResetPasswordContent, {})
	});
}
//#endregion
//#region app/[locale]/(marketing)/terms/page.tsx
var page_exports$2 = /* @__PURE__ */ __exportAll({
	default: () => TermsPage,
	generateMetadata: () => generateMetadata$1
});
var getNestedValue = (obj, path, values) => {
	const keys = path.split(".");
	let current = obj;
	for (const key of keys) if (typeof current === "object" && key in current) current = current[key];
	else return path;
...
var TermsPage = async ({ params }) => {
	const { locale } = await params;
	const legal = (await loadMessages(locale)).legal;
	const t = (key, values) => getNestedValue(legal, key, values);
	const lastUpdatedDate = "18 marca 2026";
	const termsSections = [
		"generalProvisions",
		"definitions",
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", {
					...
					className: "text-sm text-text-secondary",
					children: t("termsAndConditions.lastUpdated", { date: lastUpdatedDate })
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "grid gap-8 lg:grid-cols-[minmax(0,1fr)_280px]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(TableOfContents, {
					sections: termsSections,
					namespace: "termsAndConditions"
				}), termsSections.map((sectionId) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(LegalSection, {
					id: sectionId,
					namespace: `termsAndConditions.sections.${sectionId}`
				}, `termsAndConditions:${sectionId}`))] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("aside", {
					className: "hidden lg:block",
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "sticky top-24 space-y-4 text-sm text-text-secondary",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
...
//#endregion
//#region app/page.tsx
var page_exports$1 = /* @__PURE__ */ __exportAll({ default: () => RootPage });
function RootPage() {
	redirect(`/pl`);
}
//#endregion
//#region app/[locale]/(marketing)/HomeContent.tsx
var HomeContent = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'HomeContent' is called on server");
}, "d4cb2a52526c", "HomeContent");
//#endregion
//#region app/[locale]/(marketing)/page.tsx
...
function HomePage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(HomeContent, {});
}
//#endregion
...
function __VINEXT_CLASS(routeIdx) { return ((routeIdx) => {
    switch (routeIdx) {
      case 0: return new Map([[0, "static"], [1, "static"]]);
      case 1: return new Map([[0, "static"], [1, "static"]]);
      case 2: return new Map([[0, "static"], [1, "static"]]);
      case 3: return new Map([[0, "static"], [1, "static"]]);
      case 4: return new Map([[0, "static"], [1, "static"]]);
      case 5: return new Map([[0, "static"], [1, "static"]]);
      case 6: return new Map([[0, "static"], [1, "static"]]);
      case 7: return new Map([[0, "static"], [1, "static"]]);
      case 9: return new Map([[0, "static"], [1, "static"]]);
      default: return null;
    }
  })(routeIdx); }
...
var routes = [
	{
		...
		ids: {
			"route": "route:/:locale/about",
			"page": "page:/:locale/about",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]", "layout:/[locale]/(marketing)"],
			"templates": [],
			"slots": {}
		},
	...
	},
	{
		...
		ids: {
			"route": "route:/:locale/activate",
			"page": "page:/:locale/activate",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]", "layout:/[locale]/(public)"],
			"templates": [],
			"slots": {}
		},
		pattern: "/:locale/activate",
		patternParts: [":locale", "activate"],
		isDynamic: true,
		params: ["locale"],
		rootParamNames: ["locale"],
		page: page_exports$8,
	...
	},
	{
		...
		ids: {
			"route": "route:/:locale/forgot-password",
			"page": "page:/:locale/forgot-password",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]", "layout:/[locale]/(public)"],
			"templates": [],
		...
		pattern: "/:locale/forgot-password",
		patternParts: [":locale", "forgot-password"],
		isDynamic: true,
		params: ["locale"],
		rootParamNames: ["locale"],
		page: page_exports$7,
	...
	},
	{
		...
		ids: {
			"route": "route:/:locale/login",
			"page": "page:/:locale/login",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]", "layout:/[locale]/(public)"],
			"templates": [],
	...
	},
	{
		...
		ids: {
			"route": "route:/:locale/privacy",
			"page": "page:/:locale/privacy",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]", "layout:/[locale]/(marketing)"],
			"templates": [],
	...
	},
	{
		...
		ids: {
			"route": "route:/:locale/register",
			"page": "page:/:locale/register",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]", "layout:/[locale]/(public)"],
			"templates": [],
	...
	},
	{
		...
		ids: {
			"route": "route:/:locale/reset-password",
			"page": "page:/:locale/reset-password",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]", "layout:/[locale]/(public)"],
			"templates": [],
		...
		pattern: "/:locale/reset-password",
		patternParts: [":locale", "reset-password"],
		isDynamic: true,
		params: ["locale"],
		rootParamNames: ["locale"],
		page: page_exports$3,
	...
	},
	{
		...
		ids: {
			"route": "route:/:locale/terms",
			"page": "page:/:locale/terms",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/[locale]",
			"layouts": ["layout:/[locale]", "layout:/[locale]/(marketing)"],
			"templates": [],
	...
	},
	{
		...
		routeHandler: null,
		layouts: [layout_exports$2, layout_exports$1],
		routeSegments: ["[locale]", "(marketing)"],
		templateTreePositions: [],
		layoutTreePositions: [1, 2],
		templates: [],
		errors: [null, null],
...
var __configRewrites = {
	...
	"afterFiles": [{
		"source": "/api/:path*",
		"destination": "https://api.restorio.org/api/:path*"
	}],
	"fallback": []
};
var __configHeaders = [];
var __publicFiles = new Set([
	"/favicon.ico",
	"/images/about/customer.png",
	"/images/about/kitchen.png",
	"/images/about/owner.png"
]);
...
var _virtual_vinext_rsc_entry_default = createAppRscHandler({
	...
	dispatchMatchedPage({ cleanPathname, handlerStart, interceptionContext, isRscRequest, middlewareContext, mountedSlotsHeader, params, request, route, scriptNonce, searchParams }) {
	...
	handleServerActionRequest({ actionId, cleanPathname, contentType, interceptionContext, isRscRequest, middlewareContext, mountedSlotsHeader, request, searchParams }) {
		return handleServerActionRscRequest({
			actionId,
			allowedOrigins: __allowedOrigins,
			buildPageElement({ route: actionRoute, params: actionParams, cleanPathname: actionCleanPathname, interceptOpts, searchParams: actionSearchParams, isRscRequest: actionIsRscRequest, request: actionRequest, mountedSlotsHeader: actionMountedSlotsHeader }) {
	...
	isMiddlewareProxy: true,
	makeThenableParams,
	matchRoute,
	metadataRoutes,
	middlewareModule: proxy_exports,
	...
	rootParamNamesByPattern: {
		...
		"/:locale/forgot-password": ["locale"],
		"/:locale/login": ["locale"],
		"/:locale/privacy": ["locale"],
		"/:locale/register": ["locale"],
		"/:locale/reset-password": ["locale"],
		"/:locale/terms": ["locale"],
		"/:locale": ["locale"]
	},
	setNavigationContext: setAppNavigationContext,
	staticParamsMap: {
		"/:locale/about": null,
		"/:locale/activate": null,
		"/:locale/forgot-password": null,
		"/:locale/login": null,
		"/:locale/privacy": null,
		"/:locale/register": null,
		"/:locale/reset-password": null,
		"/:locale/terms": null,
		"/:locale": null
	},
